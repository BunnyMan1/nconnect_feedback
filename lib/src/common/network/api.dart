...
class NdashApi {
  ...
  Future<void> sendFeedback({
    ...
    final uri = Uri.parse("http://10.11.13.113:5000/api/common/v1/media");
    ...
    print(
        "  --> the request that is being sent to server : ${request.toString()}  $argumentsNN  ");
...
class NdashApiException implements Exception {
  ...
  @override
  String toString() {
    return 'NdashApiException{${response?.statusCode}, message: $message, body: ${response?.body}';
  }
}
